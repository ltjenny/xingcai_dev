    ...
    <div class="box_layer">
        ...
        <div class="login">
            <div class="sj_web_box">
                ...
                <div class="sj_web_ewm2"><img src="/images/nsc/login/wap.png?v=1.16.11.5" /><p>新版手机WAP</p></div>
            </div>
...
<div class="same_box phone_box">
	<div class="left">
    <h3>安卓客户端</h3>
    <p>下载地址：</p><a href="#" onclick="app_anzuo();" class="icon-Android">Android</a><a href="#" onclick="jjtc();" class="icon-PC">PC端下载</a>
    </div>
    <div class="img"><img src="/images/nsc/login/anzuo.png?v=1.16.11.5" /></div>
</div>

<div class="same_box pt_box">
	<div class="left">
    <h3>苹果客户端</h3>
    <p>下载地址：</p><a href="#" onclick="jjtc();" class="icon-iPhone">iPhone</a><a href="#" onclick="jjtc();" class="icon-PC">PC端下载</a>
    </div>
    <div class="img"><img src="/images/nsc/login/iPhone.png?v=1.16.11.5" /></div>
</div>
