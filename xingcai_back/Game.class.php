...
class Game extends WebLoginBase
{
    ...
    //北京
    public final function beijing(){
		$this->display('game/beijing.php');
    }
    
    //福彩
    public final function fucai(){
		$this->display('game/fucai.php');
    }
    
    //新疆
    public final function xinjiang(){
		$this->display('game/xinjiang.php');
    }

    //天津
    public final function tianjing(){
		$this->display('game/tianjing.php');
    }

    //江苏快三
    public final function jiangsukuaisan(){
		$this->display('game/jiangsukuaisan.php');
    }

    //香港六合彩
    public final function xianggangliuhecai(){
		$this->display('game/xianggangliuhecai.php');
    }
