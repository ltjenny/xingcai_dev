        ...
        <div class="ui-main clear" id="ulMain">
            ...
            <div class="con_box">
                <div class="table-list">
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th class="aleft pfr-15px">公告列表</th>
                            </tr>
                        </thead>
                        <tbody data-bind="foreach:list" id="have_data">
                            <tr>
                                <td>
                                    <div data-notice="notice" class="aleft pfr-15px">
                                        <label data-bind="text:$index() + 1" class="dib w30px mr20px">1</label>
                                        <label data-bind="text:FNoticeTitle" class="dib"></label> &nbsp;【 <span data-bind="text:FLastEditTime"></span> 】
                                    </div>
                                    <div class="aleft dn" style="padding:30px;line-height:20px;">
                                        <pre data-bind="html:FNoticeContent"></pre>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <div data-bind="page:currentPage" class="page bottom-page"></div>
                </div>
            </div>
            <script src="/js_new/UserCenter/NoticeAnnou.js?c3d1e3565b"></script>
        </div>
    </div>
